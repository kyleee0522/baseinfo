package com.kt.icis.oder.baseinfo.comcd.command.controller;
...
import com.kt.icis.oder.baseinfo.comcd.command.controller.client.WcCsyscdCmdClnt;
import com.kt.icis.oder.baseinfo.comcd.command.controller.client.payload.in.WcCsyscdInCmdPyld;
import com.kt.icis.oder.baseinfo.comcd.command.controller.client.payload.in.dto.WcCsyscdInCmdDto;
import com.kt.icis.oder.baseinfo.comcd.command.controller.client.payload.out.WcCsyscdOutCmdPyld;
import com.kt.icis.oder.baseinfo.comcd.command.payload.in.dto.BiCsyscdInCmdDto;
import com.kt.icis.oder.baseinfo.comcd.command.repository.entity.BiCsyscdCmdEntt;
import com.kt.icis.oder.baseinfo.comcd.command.service.BiCsyscdCmdSvc;
...
public class BiCsyscdCmdCntr {
	...
	public int csyscdasync(BiCsyscdInCmdDto inDto) {
		...
		try {
			...
			log.info(json);
			ProducerRecord<String, String> producerRecord = new ProducerRecord<>("icis-oder-topic",  json);
